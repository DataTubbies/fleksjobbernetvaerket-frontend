  ...
  return (
    <div className="px-32 py-12">
      ...
      <div className="text-center">
        <h2 className="text-fleks-blue-dark text-2xl font-semibold">
          Fleksjobber Netværket
        </h2>
        <p className="text-fleks-gray-dark text-sm">
          c/o Knud Kjølhede Petersen
        </p>
        ...
        <p>
          ...
          <a
            className="text-fleks-blue-dark"
            href="https://cvrapi.dk/virksomhed/dk/fleksjobber-netvaerket/37109223"
          >
            link.
          </a>
          <div className="bg-fleks-blue h-1 w-full my-8"></div>
