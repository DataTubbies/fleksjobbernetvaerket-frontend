      ...
      {loading ? (
        ...
        <div className="relative">
          <div className="px-16 lg:px-32 pt-16">
            <h3 className="text-fleks-blue-dark text-3xl font-semibold mb-6 z-50">OVERSIGT OVER ALLE ARTIKLER</h3>
          </div>
          ...
          <div className="flex justify-center items-center px-12 lg:px-32 w-30 gap-4">
            <div className="flex" onClick={handleSort}>
              ...
              <img src="../../images/sortArrows.svg" alt="Sort Arrows" className="ml-2 cursor-pointer w-5 h-5 " />
            </div>
          ...
          {paginatedPosts.map((post) => (
            <React.Fragment key={post.id}>
              <PostEntry title={post.title.rendered} excerpt={post.excerpt.rendered} date={post.date} author={post.author} link={post.link} slug={post.slug} />
