      ...
      <div className="grid grid-cols-1 gap-8 py-8 mx-4 sm:mx-12 md:mx-32 my-10 rounded-sm">
        {jobs.map((job) => (
          <div className="p-4 prose" key={job.acf.jobtitel}>
            ...
            <p className="my-4 sm:my-7">
              <span className="font-semibold">Jobreference: </span>
              {job.acf.jobreference}
            </p>
            <p className="my-4 sm:my-7">
              {" "}
              <span className="font-semibold">Jobbeskrivelse: </span>
              {job.acf.Jobbeskrivelse}
            </p>
            {job.acf.url && (
              <a className="font-semibold text-fleks-blue hover:underline" href={job.acf.url}>
                Læs mere her
              </a>
            )}
