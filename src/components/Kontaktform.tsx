    ...
    <div className="max-w-md mx-auto justify-center justify-items-center px-4 sm:px-0">
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div className="flex items-center align-middle justify-center px-3">
          <button className="bg-fleks-blue-dark hover:bg-fleks-blue text-white font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
            Send
          </button>
        </div>
      </form>
