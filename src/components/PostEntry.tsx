...
export default function PostEntry({ title, excerpt, date, link, slug }: PostEntryProps) {
        ...
        <div className="relative col-span-4 md:col-span-3">
          ...
          <div className="lg:absolute bottom-0">
            <div id="buttons" className="flex gap-1 mt-5">
              <FacebookShareButton url={link} className="bg-fleks-gray text-white px-1 py-1 rounded-lg w-8 h-8 flex items-center justify-center">
              ...
              <TwitterShareButton url={link} className="bg-fleks-gray text-white px-1 py-1 rounded-lg w-8 h-8 flex items-center justify-center">
              ...
              <LinkedinShareButton url={link} className="bg-fleks-gray text-white px-1 py-1 rounded-lg w-8 h-8 flex items-center justify-center">
